...
enum {
	...
	DETEX_PIXEL_FORMAT_TWO_COMPONENTS_BIT = 0x20,
	/* The format has three components. */
	DETEX_PIXEL_FORMAT_THREE_COMPONENTS_BIT = 0x40,
	/* The format has four components. */
	DETEX_PIXEL_FORMAT_FOUR_COMPONENTS_BIT = 0x60,
	...
	DETEX_PIXEL_FORMAT_128BIT_PIXEL_BIT = 0x500,
	...
	DETEX_PIXEL_FORMAT_FLOAT_RGBX32 = (
		DETEX_PIXEL_FORMAT_32BIT_COMPONENT_BIT |
		DETEX_PIXEL_FORMAT_THREE_COMPONENTS_BIT |
		DETEX_PIXEL_FORMAT_128BIT_PIXEL_BIT |
		DETEX_PIXEL_FORMAT_FLOAT_BIT
		),
